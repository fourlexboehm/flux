...
pub fn drawSequencer(
    ...
    zgui.spacing();
    drawClipTools(state, clip, track_index, scene_index, min_note_duration, ui_scale);
    zgui.spacing();
    ...
    const menu_action = drawContextMenu(state, clip, min_note_duration, track_index, scene_index, quantize_beats, quantize_index);
