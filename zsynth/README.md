...
It uses Zig-friendly [CLAP](https://github.com/free-audio/clap) [bindings](https://git.sr.ht/~interpunct/clap-zig-bindings), and
...
- Flux DAW host with clip launcher, MIDI sequencing, and CLAP hosting
